      ...
      if (jj_2_2(2147483647)) {
        ...
        jj_consume_token(SEMI);
                ...
                if (mods.contains("abstract")) {
                    ...
                    memberDecl = new JMethodDeclaration( line, mods, name, type, params, null, dummyBlock );
                }
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case BOOLEAN:
